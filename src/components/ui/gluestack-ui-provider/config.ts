...
export const config = {
  light: vars({
    ...
    '--color-primary-400': '86 153 244',
    '--color-primary-500': '66 133 234',
    '--color-primary-600': '56 123 214',
    ...
    '--color-error-500': '238 104 90',
    '--color-error-400': '245 120 106',
    '--color-error-600': '210 90 78',
